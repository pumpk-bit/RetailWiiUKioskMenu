...
We won't be adding all kiosk features in the main tutorial.A few experimental features are here (high risk): [EXPERIMENTAL.MD](../AI/EXPERIMENTAL.MD). (AI warning)
